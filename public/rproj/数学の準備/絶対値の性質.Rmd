...
<details><summary>$y=|x|$のグラフ</summary>
* 関数$y=|x|$のグラフを描画する.
...
<details><summary>証明に関する補足</summary>
:::{.note}
**補足**
...
:::{.proposition #sumabs2 name="和の絶対値は絶対値の差以上"}
