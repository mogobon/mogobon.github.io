...
列$S'$を$S'=(s_0,s_1,\cdots,s_{N-1})$,  $c(L,R)=\displaystyle\bigoplus_{i=L}^{R-1} s_{i}\equiv s_{L}\oplus s_{L+1}\oplus s_{R-1}$とする. この$c$を用いた尺取り法は, $\mathrm{add}(c(l,r),s_{r})=c(l,r)\oplus s_{r}$, $\mathrm{remove}(c(l,r),s_{l})=c(l,r)\oplus s_{l}^{-1}$と置き換えて次のように表現できる.
